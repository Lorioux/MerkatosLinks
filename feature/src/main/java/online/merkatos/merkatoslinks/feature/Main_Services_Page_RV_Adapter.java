...
public class Main_Services_Page_RV_Adapter extends RecyclerView.Adapter<Main_Services_Page_RV_Adapter.AdapterViewHolder>  implements View.OnClickListener{
    ...
    *
    */
    private Main_Services_Page_RV_Adapter(Context context, @Nullable int numberOfItems){
        mContext = context;

        mNumberOfItems = numberOfItems;
    }

    public static Main_Services_Page_RV_Adapter getNewInstance(Context context, int i) {
        return  new Main_Services_Page_RV_Adapter(context, i);
    }
    ...
    public void onBindViewHolder(@NonNull AdapterViewHolder holder, int position) {
        ...
        holder.carousel_container.setAdapter(Main_Base_RecyclerView_Adapter.getNewInstance(mContext,9, "services"));
    }
